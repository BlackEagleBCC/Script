...
for (k=0;k<5;k++)
	{
		stn[k] = Math.floor((Math.random()*300)+1);
	}
 for (var h=0;h<5;h++) { 
    for (var j=h+1;j<5;j++) { 
        if (stn[h]<stn[j]) { 
